...
As a resource to the community, we have made the GenixRL prioritization score for ~1.05 million missense Variants of Uncertain Significance (VUS) from ClinVar publicly available on Zenodo.
